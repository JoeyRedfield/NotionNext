        ...
        <main
          ...
          className={
            (JSON.parse(siteConfig('LAYOUT_SIDEBAR_REVERSE'))
              ? 'flex-row-reverse'
              : '') + ' next relative flex justify-center flex-1 pb-12 px-3 lg:px-4 xl:px-6'
          }>
          {/* 左侧栏样式 */}
          ...
          <section
            id='container-inner'
            className={`${siteConfig('NEXT_NAV_TYPE', null, CONFIG) !== 'normal' ? 'mt-24' : ''} lg:max-w-4xl xl:max-w-5xl flex-grow md:mt-0 min-h-screen w-full relative z-10`}
            ref={targetRef}>
            {children}
          </section>
