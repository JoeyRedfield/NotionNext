            ...
            return (
              <li key={sLink.id}>
                <SmartLink
                  href={sLink.href}
                  target={link?.target}
                  className='next-left-submenu-link my-auto h-9 pl-4 items-center justify-start flex not:last-child:border-b-0 border-b text-gray-700 dark:text-gray-200 tracking-widest transition-all duration-200 dark:border-gray-800'>
                  {sLink.icon && (
