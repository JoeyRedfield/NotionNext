  ...
  return (
    <div className='shadow md:hover:shadow-2xl overflow-x-auto flex-grow mx-auto w-screen md:w-full '>
      <div
        ...
        className='overflow-y-hidden py-10 px-4 dark:border-gray-700 bg-white dark:bg-hexo-black-gray md:px-12 lg:px-16 lg:pt-24'>
        {showArticleInfo && (
          <header
            {...aosProps}
            className='mb-10 border-b border-dashed border-gray-200 pb-8 dark:border-gray-700'>
            {/* 头图 */}
            ...
            {/* meta */}
            <section className='next-section-title mt-2 font-light leading-7 text-sm'>
                ...
                {post?.type !== 'Page' && (
                  <>
                    <SmartLink
                      ...
                      passHref
                      legacyBehavior>
                      <div className='next-link-accent pl-1 mr-2 cursor-pointer border-b dark:border-gray-500 border-dashed'>
        ...
        <article id='article-wrapper' className='mx-auto'>
          ...
          {post && <NotionPage post={post} className='notion-post-body' />}
          <WWAds className='w-full' orientation='horizontal' />
        </article>
        ...
        {showArticleInfo && (
          <>
            ...
            <section className='flex justify-between'>
              ...
              {post.category && (
                <>
                  <div className='next-link-accent next-section-title cursor-pointer my-auto text-md mr-2 border-b border-dashed'>
                ...
                <>
                  {post.tagItems && (
                    <div className='flex items-center flex-nowrap leading-8 p-1 py-4 overflow-x-auto'>
                      <div className='next-section-title hidden md:block whitespace-nowrap'>
                        {locale.COMMON.TAGS}:&nbsp;
                      </div>
        ...
        {/* 评论互动 */}
        <div className='mt-10 border-t border-dashed border-gray-200 pt-8 duration-200 w-full dark:border-gray-700 bg-white dark:bg-hexo-black-gray'>
