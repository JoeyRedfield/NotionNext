  ...
  return (
    <aside
      ...
      className={
        ...
        ' hidden lg:block flex-col w-64 relative z-30'
      }>
      <section className='w-64'>
        {/* 菜单 */}
        <section className='next-left-panel next-card border rounded-md shadow-sm hidden lg:block mb-5 pb-4 bg-white dark:bg-hexo-black-gray hover:shadow-md transition-shadow duration-200'>
          <Logo className='min-h-32 next-left-logo' {...props} />
      ...
      <div className='sticky top-4 hidden lg:block'>
        <Card className='next-left-panel'>
          <Tabs className='next-left-tabs'>
            {showToc && (
              <div
                key={locale.COMMON.TABLE_OF_CONTENTS}
                className='dark:text-gray-400 text-gray-600 duration-200'>
                <Toc toc={post.toc} />
              </div>
            )}
            ...
            <div
              ...
              className='next-left-about mb-5 duration-200 py-6'>
              <InfoCard {...props} />
              <>
                <div className='next-muted mt-2 text-center font-light text-sm'>
                  <span className='px-1 '>
