        ...
        <Collapse isOpen={isOpen} onHeightChange={props.onHeightChange}>
          {link.subMenus.map((sLink, index) => {
            return (
              <div
                key={index}
                className='next-left-submenu-link whitespace-nowrap dark:text-gray-200
              not:last-child:border-b-0 border-b dark:border-gray-800 py-2 px-14 cursor-pointer
              font-extralight dark:bg-black text-left justify-start text-gray-600 bg-gray-50 tracking-widest transition-all duration-200'>
